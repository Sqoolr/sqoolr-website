        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <p className="text-gray-600 mb-8">
              Sqoolr is always looking to expand its capabilities through strategic integrations 
              with cutting-edge technology solutions. If you're a tech company, EdTech startup, 
              or software provider, let's collaborate to provide smarter, more efficient tools 
